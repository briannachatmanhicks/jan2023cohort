...
let house = [
    ...
    'rooms': [
            {'roomName': 'livingRoom', 
            'contents': ['couch', 'tv', 'bookcase']
            },
            {'roomName': 'kitchen', 
            'contents': ['table', 'chairs', 'dishes']
            },
            {'roomName': '1/2 Bathroom', 
            'contents': ['sink', 'toilet', 'mirror']
            }
            ]
    },
    {
    ...
    'rooms': [
            ...
            'contents': ['bed', 'dresser', 'chair', 'bathroom' ]
            },
            {
            'roomName': 'gameRoom', 
            'contents': ['tv', 'games', 'chairs', 'billiards table']
            },
            {
            'roomName': 'Office', 
            'contents': []
    ...
    'rooms': [
            {
            'roomName': 'attic', 
            'contents': ['holiday decor', 'old paintings', 'trunks']
            }
            ]
    }
]
