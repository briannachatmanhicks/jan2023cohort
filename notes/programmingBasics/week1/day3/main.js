...
var toons = [
    ...
    ////More on the loony-toons example. 
    ////What would you have to do in order to print names of looney toons born after 1950?


    for (let i = 0; i < toons.length; i++) {
        toons[i].birthDay.slice (-4, 1)
        console.log (toons[i].birthDay)
    }